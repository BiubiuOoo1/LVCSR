function epdPrm=epdPrmSet2Wavelet(fs)
% epdPrmSet2Wavelet: Set parameters for endpoint detection
%
% 	Usage:
%		epd=epdPrmSet(fs)
%
...
epdPrm.Wname='sym8';			% Default method
epdPrm.frameSize=round(fs/(16000/256));	% Frame size (fs=16000 ===> frameSize=256)
...
% For method='volhod'
epdPrm.vhRatio=0.2;	% 0.11
% epdPrm.diffOrder=1;
% epdPrm.volWeight=0.76;
epdPrm.vhMinMaxPercentile=2.3;		% 5.0%
% 
epdPrm.extendNum=1;			% Extend front and back
epdPrm.minSegment=0.034;			% Sound segments (in seconds) shorter than or equal to this value are removed
